...
public class GetClassTest {
	public static void main(String[] args) throws Exception{
		...
		if(sdf instanceof DateFormat){
			System.out.println("instanceof��sdf is DateFormat.class");
		}
		if(sdf instanceof Format){
			System.out.println("instanceof��sdf is Format.class");
		}
		if(sdf instanceof Object){
			System.out.println("instanceof��sdf is Object.class");
		}
